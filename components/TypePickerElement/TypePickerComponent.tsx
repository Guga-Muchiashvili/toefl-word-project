...
const TypePickerComponent = () => {
  ...
  return (
    <div className="w-full flex-col h-screen gap-2 flex items-center justify-center px-6 p-2 font-bebas text-6xl text-purple-600">
      <h1>Choose Type</h1>
      <div className="w-1/2 h-fit p-3 flex items-center justify-center flex-wrap gap-4">
        <div
          className="w-60 h-fit py-2 text-center cursor-pointer hover:scale-105 duration-500 shadow-lg bg-purple-600 text-white rounded-xl"
